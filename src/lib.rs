// src/lib.rs
/*
 * Core library for CronScheduler
 */
...
#[derive(Debug)]
pub struct CronSchedulerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CronSchedulerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CronScheduler processing");
    
    let mut processor = CronSchedulerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CronSchedulerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CronSchedulerProcessor::new(false);
